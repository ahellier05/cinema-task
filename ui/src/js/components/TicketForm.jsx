...
function TicketForm() {
    ...
    const increaseStandardTicketCount = () => {
        setStandardTicketCount(prevstandardTicketCount => prevstandardTicketCount + 1);
    }
    ...
    const increaseConcessionTicketCount = () => {
        setConcessionTicketCount(prevconcessionTicketCount => prevconcessionTicketCount + 1);
    }
    ...
    const increaseConcessionIMAXTicketCount = () => {
        setConcessionIMAXCount(prevconcessionIMAXCount => prevconcessionIMAXCount + 1);
    }
    ...
    return(
        ...
        <div>
            <div>
                <div>
                    <p>Standard Ticket:</p>{' '}
                        <Button onClick={increaseStandardTicketCount} variant="primary">+</Button>{' '}
                        <Button onClick={decreaseStandardTicketCount} variant="primary">-</Button>{' '}
                </div>
                <div>Standard Ticket Total: {standardTicketCount}</div>
                <br/>
                <div>
                    <p>Concession Ticket:</p>{' '}
                        <Button onClick={increaseConcessionTicketCount} variant="primary">+</Button>{' '}
                        <Button onClick={decreaseConcessionTicketCount} variant="primary">-</Button>{' '}
            ...
            <br/>
            <div>
                <ExtraForm standard3DCount={standard3DCount}
